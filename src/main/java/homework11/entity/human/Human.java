...
import homework11.converter.DataConverter;
...
//    }
    ...
    public Human(String name, String surname, String birthdate, Family family) throws ParseException {
        this.name = name;
        this.surname = surname;
        this.birthdate = DataConverter.stringToMillis(birthdate);
        this.family = family;
    ...
    //adoptedChild
    public Human(String name, String surname, String adoptChBD,int iq) throws ParseException {
        this.name = name;
        this.surname = surname;
